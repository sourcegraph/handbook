...
There are autogenerated pages at `content/product/maturity.md` and `content/product/features_by_tier.md` that are created at build time from the YAML files in the [data](./data) folder. The script which does this is in [src/scripts/generated-pages.mjs](./src/scripts/generated-pages.mjs).
