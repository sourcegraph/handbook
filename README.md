...
There is an autogenerated page at `content/product/maturity.md` that is created at build time from the YAML files in the [data](./data) folder. The script which does this is in [src/scripts/generated-pages.mjs](./src/scripts/generated-pages.mjs).
