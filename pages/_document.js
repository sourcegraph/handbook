    ...
    return (
      <Html lang="en">
        <Head>
          ...
          <link href="https://fonts.googleapis.com/css2?family=Source+Code+Pro:ital,wght@0,200;0,400;0,600;0,700;1,200;1,400;1,600;1,700&family=Source+Sans+Pro:ital,wght@0,200;0,400;0,600;0,700;1,200;1,400;1,600;1,700&display=swap" rel="stylesheet" />
          ...
          {/* Google Tag Manager */}
          <script data-cookieconsent="ignore" dangerouslySetInnerHTML={{ __html:`(function (w, d, s, l, i) {
              w[l] = w[l] || []; w[l].push({
                'gtm.start':
          ...
          <script id="Cookiebot" src="https://consent.cookiebot.com/uc.js" data-cbid="fb31dc3e-afb3-4be8-ae84-7090bba7797d"
        ...
        <body>
            ...
            <header id="header">
           		<div className="container">
           			<a href="/" id="logo"><img src="/static/sourcegraph-logo.svg" alt="Sourcegraph logo" /></a>
           			<nav>
           				<form id="search-form" method="get" action="/search">
           					{/* <input type="search" id="search-input" name="q" value="{{block "query" .}}{{end}}" */}
           					<input type="search" id="search-input" name="q" defaultValue=""
