...
This somewhat depends on which code host they're using. Look up the [product comparison with their code host](../marketing/messaging/index.md#how-is-sourcegraph-different) for details.
