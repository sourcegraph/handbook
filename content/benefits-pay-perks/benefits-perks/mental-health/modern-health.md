...
- Remember that the [Sourcegraph PTO policy](./paid-time-off-and-working-hours.md#paid-time-off-pto-and-working-hours) is meant to enable you to make time for your mental health. Team members should feel empowered to make an appointment for coaching or therapy in the middle of the day or take time off to attend an appointment. We have various emojis in Slack that you can denote as your status while you do this. Simply type in “coaching” or “therapy” to start the emoji as an indication to your peers that you are prioritizing your mental health during a block of time.
