...
- The role should be kicked off following the steps outlined [here](../../departments/talent/tools/index.mdresources_for_hiring_managers.md#1-opening-a-new-job). The role and expectations for the role need to be clearly defined and written down in the form of a job description using [this template](https://docs.google.com/document/d/1rJAYyARbegvvH_e-VTrHoFhU9cDG5WfHov3L12NeCO8/edit).
