...
- There is also an #rfcs channel you can use to follow along with RFCs as they are created. The bot that updates the channel is a [Zapier](https://zapier.com) integration; if you log in with your Sourcegraph account you should be able to see it although you only need to do this if you want to modify the bot.
