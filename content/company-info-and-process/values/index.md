...
A few examples of how we encourage high agency are by being a [handbook-first](../../handbook/index.md#what-does-it-mean-to-be-handbook-first) company, which allows anyone to change how the business operates, and by empowering engineers to spend time on projects they believe in through our policy of [innovation time](../../departments/engineering/engineering/index.md#innovation-time).
...
- We collect and curate educational resources (for use with the education budget mentioned above) in the [Educational Resources Library](../../departments/engineering/engineering/enablement/dev-experience/library.md).
- We organize occasional hackathons internally, which are opportunities to learn, experiment, and share knowledge.
- Product and Engineering teams host regular [Demo days](../../departments/engineering/team-culture/demo-day.md) in which we share progress and learn from each other.
...
- We have a framework for supporting [early-career engineers](../../departments/engineering/engineering/hiring/early-career-engineers.md).
