...
Contractors submit an invoice at the end of each month via [email to [Sourcegraph@Bill.com, with finance@sourcegraph.com copied on all emails](mailto:Sourcegraph@Bill.com?cc=finance@sourcegraph.com). All invoices will be paid through Veem. You should have received an invite to your personal email for a Veem account as part of onboarding.
