...
Our [goals](../company/goals/index.md) describe what each of us is working toward now (so that we succeed in our long-term mission).

## Values

Our [values](../company/values.md) are the principles and beliefs that help us achieve our [goals](../company/goals/index.md) and make our direction real.
