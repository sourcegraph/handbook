...
- **The Handbook is a source of truth** at Sourcegraph, and its information is expected to be accurate and up-to-date. It should be documented in the handbook for any company process to be in force as a practice here at Sourcegraph. A Google Doc or pending PR to the handbook is not sufficient as a source of truth because using those reduces the effectiveness of the handbook as a trusted source of knowledge. Further, never needing to merge your change to bring it into force discourages making small, iterative improvements.
