...
- Breaking down the error:
  ...
  - `must link to .md file, not ../technical-success/support-workflow `
...
- **Note:** if there is an anchor tag in the link, the .md goes before the anchor tag, like `../technical-success/support/support-workflow.md#support-workflow`.
