...
The primary goal for Customer Success is to achieve high customer retention and provide a solid foundation for expansion into the account. This is achieved by engaging with the customer in an ongoing fashion. This model defines a consistent approach for customer engagement to achieve these goals.

This page outlines the [values](#values) and [goals](#goals) of Customer Success at Sourcegraph. It provides a high-level overview of the [customer journey](#customer-success-journey) and what activities will take place at each point. Activities are organised around [Playbooks](customer-success-playbooks.md), which provide a consistent best practise approach to certain predictable and repeatable customer situations. Each activity can also deliver [documents](customer-success-deliverables.md) (which will be based on a [library of templates](customer-success-deliverables.md)) as part of its output.

The Customer Success motion will be rolled out over time and so this handbook will be updated as more playbooks are released. As such this current version is not the final and complete version.
...
- _CE & AE_ **[Start Onboard Planning](customer-success-playbooks.md#account-onboarding):** CE builds onboarding and engagement plans; AE gets alignment with Champion and the customer’s commitment to onboarding and engagement plans
...
- _AE & CE_ **[Book and run kickoff meeting](customer-success-playbooks.md#account-onboarding)**: review trial and business assessment results, share 30/60/90 day plan and ongoing engagement (Business Reviews, Training, etc.). Get commitment from all stakeholders to resource these meetings. Explain engagement model for things like support, product feedback, and training & enablement.
- _AE & CE_ **[Book onboarding meetings and recurring engagement meetings](customer-success-playbooks.md#account-onboarding)**
...
- For Tier 1 Accounts
  ...
  - _AE & CE_ **[Account Planning](customer-success-playbooks.md#account-planning)**
...
- For Tier 1 Accounts
  - _AE & CE & (optionally VE, Product, Marketing)_ **[Business Review with customer](customer-success-playbooks.md#business-review)**
  - _AE & CE_ **[Renewal Planning](customer-success-playbooks.md#renewal-planning)**
  - _CE_ \*\*Monthly nurture and enablement activities
- For Tier 2 & Tier 3 Accounts
  - _AE & CE_ **[Renewal Planning](customer-success-playbooks.md#renewal-planning)**
  - _CE_ **Monthly nurture and enablement activities**
