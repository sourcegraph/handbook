...
- Introduce a rollout process for our extensions (browser, IDE, etc). This process is defined for [our core-sourcegraph releases](https://handbook.sourcegraph.com/product/product_management/rollout_process), but not yet defined for extensions.
