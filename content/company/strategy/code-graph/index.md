...
- Make Sourcegraph Search work well with large-scale monorepos; some examples of achieving this could be P75 time to first result for unindexed search on monorepos larger than 200GB is < 10s and <2s for indexed, time to indexing is always <30 minutes, and we understand how search results should be ranked for monorepos. ([Search Core](./search/index.md))
