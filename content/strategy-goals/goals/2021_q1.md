...
1. **Product: Create a customer driven product process**
   ...
   1. Handbook describes the lifecycle of a feature and who is responsible for each part of the lifecycle. => [Prioritizing issues](../../departments/product-engineering/product/process/prioritizing.md).
   1. Handbook describes product planning processes and API between product and engineering. => [Planning](../../departments/product-engineering/process/planning-process.md).
...
1. **Build a world class engineering team.**
   ...
   1. Document how we do performance reviews and determine compensation for teammates in engineering roles. => [Reviews](../../departments/people-ops/process/impact-reviews.md), [compensation](../../benefits-pay-perks/pay-expenses/compensation/index.md), updated offer bands.
