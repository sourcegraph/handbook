...
1. **Product: Create a customer driven product process**
   ...
   1. Handbook describes the lifecycle of a feature and who is responsible for each part of the lifecycle. => [Prioritizing issues](../../departments/engineering/product/process/prioritizing.md).
