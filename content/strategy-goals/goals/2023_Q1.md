...
1. **OBJECTIVE: Empower the business through better visibility of data**
   ...
   - KR: [Data & Analytics] Identify and provide CE with a central location to view product and Salesforce data that informs our approach with customers upon renewal, particularly for those renewals where direct competition is a factor.
