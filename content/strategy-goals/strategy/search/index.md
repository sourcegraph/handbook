...
Sourcegraph aims to be a platform powered by code search. There are two teams that work together to make this possible: [Search Product](../../../departments/engineering/dev/code-graph/search/product.md) and [Search Core](../../../departments/engineering/dev/code-graph/search/core.md), with the Product team focusing primarily on the user-facing aspects of search, and the Core team focusing on backend, relevancy, and performance. This page outlines the vision, strategy and goals that are shared by both teams.
...
- [Completed goals](../../../departments/engineering/dev/code-graph/search/goals_completed.md)
