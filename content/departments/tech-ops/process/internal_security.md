...
* Create a complex laptop password* that meets our password requirements below.

* Encryption is enabled on your device. Below are links to steps on how you can turn on device encryption for MacOS and Windows.						
...
* Your laptop screen is set to lock after **5 Minutes** of inactivity. Steps on how to set screen lock/screensaver times for MacOS and Windows are below.
...
* Firewall is enabled on your device. Steps on how to enable firewall for MacOS and Windows are below.
