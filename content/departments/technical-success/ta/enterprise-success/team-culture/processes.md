...
- Determine applicability for tearing down cloud instance
  - Check Vitally report for the Deployment Method field of the Account:
    - If Deployment Method is Sourcegraph Managed:
      ...
      - In a public channel, ex. customer-X, notify the account team that you are about to submit a Cloud Teardown request [here.](https://handbook.sourcegraph.com/departments/cloud/#tear-down-a-cloud-instance---new-request)
