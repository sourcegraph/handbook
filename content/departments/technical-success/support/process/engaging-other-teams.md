...
- `CVS` should be routed to the [Batch Changes team](../../../engineering/teams/search-suite/batch-changes/index.md)
- `license enforcement/management` should be routed to the [Batch Changes team](../../../engineering/teams/search-suite/batch-changes/index.md) (though these should always go through the CE)

Note that this section applies to backend connections with code hosts, such as repository cloning and syncing. Questions about [frontend/UI integrations with code hosts](#browser-extensions-and-code-host-native-integrations) (e.g., getting code intelligence inside of a code host) should be routed to the [Search Suite team](../../../engineering/teams/search-suite/index.md).
...
Any questions about the browser extension or code host native integrations should be routed to the [Search Suite team](../../../engineering/teams/search-suite/index.md).
...
Any questions about Batch Changes should be routed to the [Batch Changes team](../../../engineering/teams/search-suite/batch-changes/index.md).
...
Any questions about Code Insights should be routed to the [Code Insights Team](../../../engineering/teams/search-suite/code-insights/index.md)
