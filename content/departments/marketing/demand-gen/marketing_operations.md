...
- **Salesforce-** Hubspot passes lead and marketing touchpoint data over to Salesforce so that sales can follow up on individuals interested in Sourcegraph. For more information on Salesforce you can head over to this [handbook page](https://handbook.sourcegraph.com/departments/sales/tools/salesforce/#how-we-use-salesforce).
...
- **Leads** are individuals that have not been qualified yet which is why they are not associated with accounts or opportunities in Salesforce. Leads are discussed [here](https://handbook.sourcegraph.com/departments/sales/tools/salesforce/#lead-creation) It's important to note that these individuals are not surfaced to the SDR team just yet.

- **Marketing Qualified Leads (MQL)** inbound generated leads that reach a Hubspot Score of 15 points signifiying that they are ready for sales outreach. These MQLs are surfaced to the SDR team with the Lead Lifecycle Stage of MQL. For a high level view of Marketing Qualified Lead scoring you can head over to this [handbook page](https://handbook.sourcegraph.com/departments/bizops/process/product_led_growth/#marketing-qualified-lead-mql) for a more granular/technical view of our lead scoring set up you can view that in our working [lead scoring model here](https://docs.google.com/spreadsheets/d/1mAa2bueT8BrVjd5H5PQjKb7QMVFYObHYwg18ox02vsk/edit#gid=0).

- **Product Qualified Leads (PQL)** product generated leads that receive an A or B product usage grade that signifies strong engagement with our products. These PQLs are surfaced to the SDR team with the Lead Lifecycle stage of PQL. If you're interested in learning more about our product engagmenet scoring set up you can head over to this [handbook page](https://handbook.sourcegraph.com/departments/bizops/process/product_led_growth/#product-qualified-lead-pql).
