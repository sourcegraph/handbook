...
- **Leads** are individuals that have not been qualified yet which is why they are not associated with accounts or opportunities in Salesforce. Leads are discussed [here]("../../sales/tools/salesforce/.md#lead-creation") It's important to note that these individuals are not surfaced to the SDR team just yet.

- **Marketing Qualified Leads (MQL)** inbound generated leads that reach a Hubspot Score of 15 points signifiying that they are ready for sales outreach. These MQLs are surfaced to the SDR team with the Lead Lifecycle Stage of MQL. For a high level view of Marketing Qualified Lead scoring you can head over to this [handbook page]("../../bizops/process/product_led_growth/.md#marketing-qualified-lead-mql") for a more granular/technical view of our lead scoring set up you can view that in our working [lead scoring model here](https://docs.google.com/spreadsheets/d/1mAa2bueT8BrVjd5H5PQjKb7QMVFYObHYwg18ox02vsk/edit#gid=0).
