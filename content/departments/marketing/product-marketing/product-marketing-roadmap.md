...
[Sourcegraph Product teams' strategy pages](../../../strategy-goals/strategy/index.md#per-team-strategy-pages) are a public, detailed resource. These pages outline individual product team's goals and roadmaps that are aligned to the company OKRs, Sourcegraph direction, and overall product strategy.
