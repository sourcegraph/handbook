...
- **Use case**: [Code reuse](../../../strategy-goals/strategy/use-cases/incident-response)
...
- **Use case**: [Code reuse](../../../strategy-goals/strategy/use-cases/incident-response) or [Incident response](../../../strategy-goals/strategy/use-cases/incident-response)
