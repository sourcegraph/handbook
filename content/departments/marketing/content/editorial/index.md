...
Editorial falls under the [Content Marketing](../index.md) team, and primarily refers to the strategy and management of Sourcegraph's [blog](https://about.sourcegraph.com/blog/).

## Related handbook pages

- [Creating blog posts](../creating_blog_posts.md): the mechanics of creating and publishing a blog post on GitHub

## Editorial process

This section explains how team members can contribute to Sourcegraph's blog, including proposing ideas and writing posts.
...
This section explains the strategy behind the content we publish on the Sourcegraph blog.
...
Again, readers who weren’t around or who weren’t near the Ruby on Rails release might feel alienated. But the risk is worth the gain because it proves–and this is something that needs to be proven multiple times in every post–that this post is by devs, for devs.
...
The average FYI post takes three minutes and the average regular post takes 21.5 minutes.
