...
For members of Cloud, Devx and Security teams, the Slack command `break-glass` is available to grant 1h of SG_Editor access in specific GCP folders. You can find more information [here](https://github.com/sourcegraph/infrastructure/tree/main/security/tooling/break-glass-access).
