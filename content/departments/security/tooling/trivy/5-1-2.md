...
| ------ | --------------- | ------------ | --------------- | -------------------------------------------------------------------------------------------------------------- | ------------------------ | ------- |
| [CVE-2023-32731](https://github.com/advisories/GHSA-cfgp-2977-2fmm) | caddy/caddy | High         | 7.5             | Info                                                                                                           | 0                        | Caddy is used as a proxy for the Sourcegraph frontend in some deployment types, but this vulnerability is not exploitable as the frontend doesn’t accept gRPC requests |     | 
