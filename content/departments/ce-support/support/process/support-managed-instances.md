...
To fully access managed instances, follow these [docs](../../../engineering/engineering/admin-exp/devops/managed/index.md#access)
...
Next, read the [managed instances operations](../../../engineering/engineering/admin-exp/devops/managed/operations.md) page in its entirety. This provides direction for using the gcloud in the command line to debug managed instances, and is _absolutely necessary_ reading. Bookmark the page. You will revisit it often.
