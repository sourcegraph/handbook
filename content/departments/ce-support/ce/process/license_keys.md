...
As part of the Managed Instance creation process, the CE should create a license key for the new instance. Per our [steps](../../../engineering/teams/devops/managed/creation_process.md#configuring-license-sso-and-repositories)
