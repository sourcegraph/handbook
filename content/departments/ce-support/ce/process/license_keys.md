...
For a new trial, create a _new_ subscription. You will only use this for the trial. (Follow the instructions below from start to finish.). Cloud trials submitted through signup.sourcegraph.com are handled [differently](../../../engineering/product/teams/growth/cloud-trial-operations.md).
