...
- #discuss-code-search channel or @code-search-team in Slack.
- @code-insights-support to ping the engineer on weekly support rotation.
- [code-insights](https://github.com/sourcegraph/sourcegraph/issues/new?labels=code-insights) label on GitHub.
- @sourcegraph/code-search team on GitHub
