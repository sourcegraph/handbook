...
Incidents which affect managed instances handled according to our [incidents](../../../dev/process/incidents/index.md) process.
...
- testing changes prior to the monthly upgrade on customer instances. upon a new release is made available, DevOps team will follow [managed instances upgrade tracker](../../../dev/process/releases/upgrade_managed_issue_template.md) to proceed with upgrade process.
...
1. New version is released via [release guild](../../../dev/process/releases/release_guild.md)
1. Github issue in [Sourcegraph repository](https://github.com/sourcegraph/sourcegraph) is open based on the [managed instances upgrade template](../../../dev/process/releases/upgrade_managed_issue_template.md)
