...
5. Assuming `terraform apply` succeeds, update the [security infrastructure](./index.md) page and the [GCP](../../../dev/tools/infrastructure/ghe.md#sourcegraph-security) page of the handbook to reflect the new project.
