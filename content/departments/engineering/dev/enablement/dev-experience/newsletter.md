...
## TODO new how-tos CI soft fail + notify

TODO JH https://github.com/sourcegraph/sourcegraph/pull/38718
...
**Background updates**: no longer will `sg` commands block sporadically as it updates itself! Updates now happen in the background, prioritizing your command while an update happens. Note that `sg` will wait until the update completes before exiting.
