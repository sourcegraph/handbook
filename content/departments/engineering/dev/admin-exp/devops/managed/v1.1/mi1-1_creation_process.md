...
1. Ping the `@security-support` handle in the [#security](https://sourcegraph.slack.com/archives/C1JH2BEHZ) channel and ask them to onboard audit logging for the customer.
