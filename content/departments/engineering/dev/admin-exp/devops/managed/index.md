...
- [application performance metrics](./operations/#performance-checks) - configured in customer intance [site-config.json](https://docs.sourcegraph.com/admin/config/site_config) via `mg cli` during instance creation
