...
We do not have any ongoing commitments as of right now since the most recent commitment expired. The [DevOps](../../../teams/devops/index.md) team is currently investigating resource usage as part of an effort to rightsize GCP consumption.
