...
- [Managed instances](../../../teams/devops/managed/index.md) are deployments of Sourcegraph we manage for customers.
...
For deployments of Sourcegraph we manage for customers, see [managed instances](../../../teams/devops/managed/index.md).
...
- [Operations](../../../teams/devops/managed/operations.md)

### devmanaged.sourcegraph.com

This deployment is a [managed instance](../../../teams/devops/managed/index.md) used by Distribution for experimenting with managed instances in general.
