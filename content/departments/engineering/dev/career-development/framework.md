...
Expectations for a level add to the expectations of earlier levels. In addition, we expect engineers at all levels to exhibit our [values](./company-info-and-process/values.md).
