...
- **Validation**. PR-FAQs should be backed by user or customer insight: either through research, direct conversation with customers, or input from the GTM team. Any associated customer Product Gaps should be indicated as such on the PRFAQ.
