...
- **Validation**. PR-FAQs should be backed by user or customer insight: either through research, direct conversation with customers, or input from the GTM team. Any associated customer Product Gaps should be indicated on the PRFAQ. Each PR-FAQ should be validated by insights from 5 customers (or Sourcegraph for initiatives that are 100% internal).
