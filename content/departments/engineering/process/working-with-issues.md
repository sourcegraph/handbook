...
Note that customers are not expected to follow this process and cannot label issues. The [PM on feedback rotation](../product/process/feedback/product_feedback_rotation) makes sure that issues submitted by users outside Sourcegraph get labeled properly, so that they get on the owning team's radar.
