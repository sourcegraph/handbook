...
- **Step 2**: Check to see that your recruiter has added you to job project and that you have full project access.
- **Step 3**: Now that you have access to the project, coordinate with your recruiter on an [engagement strategy](https://github.com/sourcegraph/handbook/blob/main/content/departments/people-talent/talent/process/linkedin.md#engagement-strategy). The engagement strategy is an agreement on how you and the recruiter would like to collaborate and interact with each other within the LinkedIn Project.

## How to use LinkedIn Recruiter as a Recruiter / Sourcer

- During onboarding you should already have an invitation to activate your license. When you're activating your license, ensure you have the appropriate recruiter admin permissions. If you don't, you can reach out to #it-tech-ops in Slack or the #talent-team-private-channel.

  - You should have the following permissions: Hiring Project Creator License, Recruiter Searcher, Product Settings Admin, and Public Notes Viewer
...
- Before you jump in and start building projects and sending inmails, become familiar with:
  ...
  - [How Recruiters and Sourcers partner up with one another](https://github.com/sourcegraph/handbook/blob/main/content/departments/people-talent/talent/process/how_to_be_a_sourcer_at_sourcegraph.md#how-to-partner-with-recruiters)
  - [How Recruiters and Sourcers partner up with Hiring Managers](https://github.com/sourcegraph/handbook/blob/main/content/departments/people-talent/talent/process/how_to_be_a_sourcer_at_sourcegraph.md#how-to-partner-with-hiring-managers)

- Building out Projects for a new job opening:

  - **Step 1**: Recruiter or Sourcer will [create the project](https://www.linkedin.com/help/recruiter/answer/a417035/create-a-project-in-recruiter-and-recruiter-lite?lang=en) (be sure to coordinate with each other to avoid duplication of effort).
  - **Step 2**: Recruiter or Sourcer will name the project using a standard naming convention so that project collaborators know exactly which role this project is for.
...
- Finding high potential candidates through representative talent searches
  ...
  - Your search criteria does not have unrealistic requirements
...
The Hiring Manager and Recruiter will generally work together on setting up the search criteria based on the required qualifications and spend some time reviewing an initial set of profiles together so that they are on agreement on what the ideal profiles are for the role.
...
Hiring Manager and Recruiter will also determine their outreach strategy regarding how to engage with ideal profiles. Typically the recruiter will do the initial outreach via inmail or email and then set up an intro call. At times it may be appropriate for the recruiter to request the hiring manager to message potential profiles.
