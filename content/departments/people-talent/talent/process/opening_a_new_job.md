...
- Input all required fields for the "Hiring team", "Job kickoff", "Scorecard", "Interview plan", "Job Post" and "Email notifications".
  - **Important note:** When editing the job post in Greenhouse, make sure to include the target compensation on the custom application question asking candidates, "Please note that the target compensation for this role is ___. Are you aligned with this compensation?" 
