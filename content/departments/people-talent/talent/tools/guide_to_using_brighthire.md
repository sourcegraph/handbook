...
If you'd like to automate filling in your scorecard by leveraging notes that the AI notetaker has created for you, click on the "AI Notes" tab on your BrightHire side panel in the Greenhouse scorecard. Then, simply click the blue “Import All Notes” button in the scorecard. Your AI notes will automatically be uploaded to the questions they pertain to when a match is detected. Any unmatched AI notes will be pasted to the "Key Takeaways" field of your scorecard.  Loom instructions for step 6 can be found [here](https://help.brighthire.ai/en/articles/4606106-using-greenhouse-with-brighthire-for-interviewers).
