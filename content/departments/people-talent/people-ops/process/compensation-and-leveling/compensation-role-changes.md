# Requesting changes in BambooHR: Compensation, Role, and Promotion workflows
...
People Ops will loop in Tech Ops and Payroll (if applicable) via the #wg-bamboo-org-updates, then action all necessary updates in Bamboo.
