...
When customer has decided to sign the deal, instance requestor will create [Managed Instance Convert Trial to Paid](index.md#managed-instance-requests) Github issue. This is important so that the instance lives under our production SLAs, and doesn't get terminated after a time period as a trial instance would. [Cloud Team](././index.md#team) will:
