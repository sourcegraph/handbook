...
The password reset link expires after 24h, so it's quite common that CE would have generate a new link during the initial hand-off process.

If the customer instance is a private instance (e.g. access is restrict to customer VPN only), please reach out to #cloud for assistance.
