...
The goal is eventually for these to be documented in the handbook in more detail where possible so that decisions on the ground can be made without an escalation needed, but until that's the case the procedure is for the team who is needs clarity around any of these kinds of items to generate a proposal with how they would like to proceed. This can be presented directly to the executive team member(s) who makes the decision, or if that is unknown or they are not responding in a timely manner, then Christina will either make the decision herself or find the responsible exec team member and ensure it is followed up on. Be sure when making this request to ensure it is clear that you are escalating for her to help in this way; mentioning only that you are stuck, for example, is not necessarily a clear ask for help.

Remember, when multiple departments/parties are involved it's important to lean in with empathy: [escalate cleanly](../../../../company-info-and-process/communication/conflicts.md#clean-escalation) and ensure that everyone understands each others views in any proposals that are prepared. You can't always come to an agreement because of different priorities/contexts, but you should always be able to come to a mutual understanding of the trade-offs and present those together to a decision maker.
