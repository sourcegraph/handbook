...
- [Managed instances](../../cloud/delivery/managed/index.md) are deployments of Sourcegraph we manage for customers.
...
For deployments of Sourcegraph we manage for customers, see [managed instances](../../cloud/delivery/managed/index.md).
...
- [Operations](../../cloud/delivery/managed/operations.md)

### devmanaged.sourcegraph.com

This deployment is a [managed instance](../../cloud/delivery/managed/index.md) used by Distribution for experimenting with managed instances in general.
