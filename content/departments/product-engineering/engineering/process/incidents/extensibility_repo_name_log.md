...
- Introduce a rollout process for our extensions (browser, IDE, etc). This process is defined for [our core-sourcegraph releases](../../../product/product_management/process/rollout_process.md), but not yet defined for extensions.
