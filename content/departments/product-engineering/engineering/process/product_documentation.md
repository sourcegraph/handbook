...
Whenever a feature is changed, updated, introduced, or [deprecated](../../product/processdeprecation_process.md), the pull request introducing these changes must be accompanied by the documentation (either updating existing ones or creating new ones).
