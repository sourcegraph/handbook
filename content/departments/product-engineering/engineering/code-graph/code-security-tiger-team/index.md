...
- **OWASP**: The Open Web Application Security Projec. A nonprofit foundation that works to improve the security of software.
...
- **SCA**: Softare Composition Analysis. An automated process to identify dependencies of a software. SCA tools analyzes the application's **dependencies** for potential vulnerabilities.
