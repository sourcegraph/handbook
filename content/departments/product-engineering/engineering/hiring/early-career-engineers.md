...
The initial expectations of a fully-onboarded early-career engineer are [defined in the IC1 career level](../career-development/framework/index.md#ic1). In addition to these, we also expect all engineers to exhibit [our values](../../../../company-info-and-process/values/index.md).
