...
#### Who are our active Resellers?

Our active Resellers are inventoried [here](https://handbook.sourcegraph.com/departments/sales/tools/referral_and_reseller_policy/#referral-and-resale-partner-agreement-inventory) and the agreements can be found [here](https://drive.google.com/drive/u/0/folders/1BnjAnhqinQ5cLmHjsxuuvWfGVVs_h5Ku)

#### Do I have to enter into a Reseller Agreement if the Customer wants to use a partner on a deal?

No, if a Customer wants to use a reseller for billing purposes or to avoid our contracting processes, there´s no need to enter into a Reseller Agreement as this program is intended to build a long-term strategic relationship with the partner. For these cases where the Customer is aiming to reduce complexity and time, we may sign an Order Form with their proposed reseller. We will add our reseller terms to the Order Form and pass-through language, that incorporates by reference the governing terms to bind the Customer to the duties and obligations of our agreement.
