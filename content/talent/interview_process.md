...
- Step 2: If Hiring Manager chooses to advance a candidate following the Hiring Manager screen, the Recruiting Coordinator schedules additional interviews in the interview process (below). All interviewers must review the [interview training](https://handbook.sourcegraph.com/talent/interview_training#2-structured-interviewing) and Guide to Using Brighthire before conducting interviews.
