...
- Step 2: the **Recruiter** opens the job in Greenhouse by copying the "Template" job and builds out the interview plan, adding all behavioral-based, structured questions directly into each interview stage. All interview stages should use the standard interview titles, found [here](./types_of_interviews.md).  You can read more about the importance of structured interviewing [here](https://handbook.sourcegraph.com/talent/interview_training#2-structured-interviewing).
...
- Step 2: If Hiring Manager chooses to advance a candidate following the Hiring Manager screen, the Recruiting Coordinator schedules additional interviews in the interview process (below). All interviewers must review the [interview training](https://handbook.sourcegraph.com/talent/interview_training#2-structured-interviewing) and [Guide to Using Brighthire](https://handbook.sourcegraph.com/talent/hiring/guide_to_using_brighthire#guide-to-using-brighthire) before conducting interviews.
