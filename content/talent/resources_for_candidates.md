...
We are an [all-remote company](../company-processes/remote/index.md) with teammates across the globe. Our [company values](../company-processes/values/index.md) are the beliefs and principles that help us achieve our [strategy](../strategy-goals/strategy/index.md#mission), and build an [inclusive team](../company-processes/values/index.md#be-welcoming-and-inclusive). They apply at every level of our organization, and we talk to every candidate about our values during our [values interview](./types_of_interviews.md#values-interview).
...
- [Asynchronous communication at Sourcegraph](../company-processes/communication/asynchronous-communication.md)
