...
We expect every teammate, team, and our company to live up to the [Sourcegraph values](../../company-info-and-processes/values/index.md). It is therefore important that we evaluate every candidate on the values to determine how successful they will be within Sourcegraph. Because of this, **all candidates,** regardless of level or role, go through a [values interview](../types_of_interviews.md#values-interview) as part of their interview process with Sourcegraph.
