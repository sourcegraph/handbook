...
1. Address any errors in the [Handbook Checks](handbook-check-failures.md#broken-link). Since you are changing the location of a file, any existing links to that file will break. You may see errors like this:
