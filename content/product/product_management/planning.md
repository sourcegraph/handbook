...
We ask that teams leverage the [Strategy page template](https://github.com/sourcegraph/about/blob/main/page_templates/strategy_template.md) when creating and updating content.
