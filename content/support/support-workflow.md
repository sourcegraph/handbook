...
- *Important note*: CS does not join external Slack accounts except for if a strategic customer requires this; customers who are not able to join our Slack/connect their Slack to ours, can engage support via email.
