...
- RFCs (requests for comment)
  ...
  - [How we use RFCs](../../company-info-and-processes/communication/rfcs/index.md)
...
For a list of engineering relevant Slack channels to join see the [team chat](../../company-info-and-processes/communication/team_chat.md#engineering) page in the handbook.
