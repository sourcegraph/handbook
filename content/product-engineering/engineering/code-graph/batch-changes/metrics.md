...
- **Batch Changes MAU:** A [visitor](../../../../bizops/user_definitions#visitor) who triggers any GUI event happening on a Sourcegraph Batch Changes property in a given month. We do not yet track CLI events.
